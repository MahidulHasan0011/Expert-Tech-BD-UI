...
export class UserDataService {
  ...
  checkStatusInWishlistWithBookId(bookId: string) {
    return this.httpClient.get<{ exists: boolean, message: string }>(API_WISHLIST + 'get-status-of-book-in-wishlist/' + bookId);
  }

  getBooksFromWishlist() {
    return this.httpClient.get<{ data: Product[], message: string }>(API_WISHLIST + 'get-all-book-from-wishlist');
  }

  deleteBookByBookIdFromWishlist(bookId: string) {
    console.log(bookId);
    return this.httpClient.delete<{ message: string }>(API_WISHLIST + 'delete-book-from-wishlist-by-book-id/' + bookId);
  }
