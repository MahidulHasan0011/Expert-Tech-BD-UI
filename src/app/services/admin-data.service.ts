...
export class AdminDataService {
  ...
  checkAndGetAdminByPhone(data: string) {
    return this.httpClient.get<{ data: boolean, message: string }>(API_ADMIN + 'check-admin-by-phone/' + data);
  }
  editAdminPassword(data: any) {
    return this.httpClient.post<{ message: string }>(API_ADMIN + 'edit-admin-password', data);
  }

  updateAdminPassword(data: object) {
    return this.httpClient.post<{ message: string }>(API_ADMIN + 'update-admin-password', data);
  }
