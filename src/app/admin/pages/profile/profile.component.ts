...
export class ProfileComponent implements OnInit {
  ...
  private setData() {
    ...
    this.imgPlaceHolder = this.admin?.profileImg ? this.admin?.profileImg as string : this.staticImage;
  }
    ...
    this.fileUploadService.uploadSingleImage(data)
      .subscribe(res => {
        ...
        if (this.admin.profileImg) {
          this.removeOldImageFromServer(this.admin.profileImg as string);
        }
  ...
  removeOldImageFromServer(imgUrl: string) {
    this.fileUploadService.removeSingleFile({url: imgUrl})
      .subscribe(res => {
