...
@Component({
  selector: 'app-add-offer-banner',
  templateUrl: './add-offer-banner.component.html',
  styleUrls: ['./add-offer-banner.component.scss']
})
export class AddOfferBannerComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.file === null) {
      ...
      this.addOfferBannerCardWithImage();
    }
  }
  ...
  private addOfferBannerCard(data: OfferBannerCard) {
    this.isLoading = true;
    this.shopService.addOfferBannerCard(data)
      .subscribe(res => {
  ...
  addOfferBannerCardWithImage() {
    const data: FileData = {
      fileName: this.newFileName,
      file: this.file,
      folderPath: 'offer_banner_card'
    };
