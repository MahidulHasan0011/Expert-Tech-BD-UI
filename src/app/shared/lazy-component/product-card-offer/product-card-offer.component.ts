...
@Component({
  selector: 'app-product-card-offer',
  templateUrl: './product-card-offer.component.html',
  styleUrls: ['./product-card-offer.component.scss']
})
export class ProductCardOfferComponent implements OnInit {
